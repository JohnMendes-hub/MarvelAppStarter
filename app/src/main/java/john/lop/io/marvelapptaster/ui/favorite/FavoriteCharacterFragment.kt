...
import john.lop.io.marvelappstarter.databinding.FragmentFavoriteCharacterBinding
...
class FavoriteCharacterFragment :
    BaseFragment<FragmentFavoriteCharacterBinding, FavoriteCharacterViewlModel>() {

    override val viewModel: FavoriteCharacterViewlModel by viewModels()
    ...
    private fun seputRecycleView() = with(binding){
